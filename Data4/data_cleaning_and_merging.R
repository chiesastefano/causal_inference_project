...
df_list <- list(hourly_wages, business_investment, education_level, hh_index,
                partime_contracts, productivity_pp, realgdp_pc, 
                tradeunion_density, training_education_l4w, unemployment, bankruptcy_index, registrations_index)

# Perform the left join
result_df <- hourly_wages
